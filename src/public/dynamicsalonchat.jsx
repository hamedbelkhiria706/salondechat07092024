...
<html lang="fr">
  <head>
    ...
    <title>Salons de Chat - Abonnements</title>
    <link
      rel="stylesheet"
      href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css"
    />
    <link rel="stylesheet" href="stylescss/chatsalonstyle.css" />
  </head>
  <body>
    <div id="content"></div>
    <div class="container mt-5">
      ...
      <form id="chatRoomForm" style="display: none">
        ...
        <button type="submit" class="btn btn-primary">Créer les Salons</button>
      </form>
    </div>
    ...
    ></script>
    <script src="js/dynamicsalonchat.js"></script>
