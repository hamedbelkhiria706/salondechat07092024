            ...
            <div class="row no-gutters mb-5">
              ...
              <div class="col-md-7 flex-column">
                <div class="w-100 p-md-5 p-4">
                  ...
                  <p>
                    Notre projet a été fondé avec une mission claire : rendre la
                    communication simple, rapide et accessible à tous. Nous
                  ...
                  <ul>
                    <li>
                      <strong>Innovation</strong> : Nous sommes constamment à la
                      recherche de nouvelles façons d'améliorer l’expérience de
                      chat pour nos utilisateurs.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Accessibilité</strong> : Nous croyons que tout le
                      monde, quelle que soit sa situation, doit avoir accès à
                      des outils de communication puissants et fiables.
                    </li>
                  </ul>
                  <hr />
                  <h2>Notre équipe</h2>
                  <p>
                    ...
                    experts en sécurité dédiés à fournir une application de chat
                    qui évolue avec les besoins des utilisateurs. Ensemble, nous
                    avons pour but de faire de [Nom de l’App] la meilleure
                    plateforme de chat disponible.
                  </p>
