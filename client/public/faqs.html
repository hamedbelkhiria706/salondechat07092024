    ...
    <div class="container mt-5">
      ...
      <div class="accordion" id="faqAccordion">
        <div class="card">
          ...
          >
            <div class="card-body">
              Oui, notre version de base est entièrement gratuite et vous permet
              de profiter des fonctions essentielles de chat.
            </div>
          </div>
        </div>
        <div class="card">
          ...
          >
            <div class="card-body">
              Il suffit de vous connecter à votre compte, de visiter la page des
              tarifs et de sélectionner l’abonnement Pro.
            </div>
          </div>
        </div>
        <div class="card">
        ...
        <div class="card">
          ...
          >
            <div class="card-body">
              ...
              jusqu'à 5 Mo. Avec le plan Pro, cette limite est portée à 100 Mo.
            </div>
          </div>
        </div>
        <div class="card">
          ...
          >
            <div class="card-body">
              Pour rejoindre un salon de chat, connectez-vous à votre compte et
              sélectionnez un salon dans la liste des salons disponibles.
            </div>
          </div>
        </div>
        <div class="card">
          ...
          >
            <div class="card-body">
              Oui, vous pouvez créer votre propre salon de chat en cliquant sur
              le bouton "Créer un salon" dans votre tableau de bord.
            </div>
          </div>
        </div>
        <div class="card">
          ...
          >
            <div class="card-body">
              Pour signaler un utilisateur, cliquez sur son nom dans le salon et
              sélectionnez l'option "Signaler" dans le menu déroulant.
            </div>
          </div>
        </div>
        <div class="card">
