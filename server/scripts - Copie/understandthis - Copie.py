...
def process_files(input_file, output1_file, output2_file):
    ...
    with open(output1_file, 'w') as out_file:
        out_file.write('1,"AccueilGénéralAffichageU...",""\n')
        out_file.write('2,"Nom du dé :","' + id1 + '"\n')
        out_file.write('3,"Nombre de faces :","' + str(total_lines) + '"\n')
        out_file.write('4,"(Optionnel) Image du Dé :","' + id3 + '"\n')
